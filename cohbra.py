...
st.markdown(
    f'<a href="{link_url}" style="color: white; text-decoration: none;"><h1>KPI Dashboard 2023/2024</h1></a>',
...
st.sidebar.write('<a href="https://mjmedical.sharepoint.com/:x:/s/COHBRA/EeyfkMUA6vpBv_03OhwQUI0BS7iEPk1le9DfTPkhMBLGBA?e=IheerU&nav=MTVfezI4MkIwOTM3LUU4MjUtNEYzOS1CNDBDLTNCMDA4MENEQjhEMX0" style="color: black; text-decoration: none;"><b>KPI Tracker</b></a>', unsafe_allow_html=True)
# Add hyperlink to sidebar
...
st.sidebar.write('<a href="https://mjm-kpi-tracker.streamlit.app/" style="color: black; text-decoration: none;"><b>• Dashboard</b></a>', unsafe_allow_html=True)
# Add a dividing line
st.sidebar.markdown("<hr><br><br>", unsafe_allow_html=True)
